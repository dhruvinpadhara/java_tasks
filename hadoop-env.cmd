...
set JAVA_HOME=F:\IDE\Java\jdk-11.0.10
...
@rem if your user name like C:\Users\Dhruvin patel that time you have get error like this 
@rem Error: Could not find or load main class patel
@rem Caused by: java.lang.ClassNotFoundException: patel
@rem set HADOOP_IDENT_STRING=%USERNAME%
@rem that time we have set your name is simple set not use default


set HADOOP_IDENT_STRING=Dhruvin
